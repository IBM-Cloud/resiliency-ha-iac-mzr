...
/**
* Name: web_lb_type
* Desc: Determine if a public or private 3-tier application. Valid values are public or private.
* Type: String
**/
variable "web_lb_type" {
  description = "Determine if a public or private 3-tier application. Valid values are public or private."
  type        = string
  default     = "public"
}
