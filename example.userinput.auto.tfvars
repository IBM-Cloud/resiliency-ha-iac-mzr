...
# /**
# *   Enter prefix string ending with hyphen (-).
...
# /**
# *   Enter your resource_group_name. 
# **/
# resource_group_name = "Enter your Resource Group Name"


# /** 
#     This is the list of the existing ssh key/keys of user's system which will be used to login to the Bastion server. You can check your key name in IBM cloud.
...
# /**
# *   Enter the IOPs (IOPS per GB) tier for db data volume.It is the value of Input/Output per second in GB. 
...
# *   Regardless the policies threshold. Here we have 3 there must be two VSI created. 
# **/
# web_min_servers_count = "3"
