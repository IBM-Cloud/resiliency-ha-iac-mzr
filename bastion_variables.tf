...
* Name: bastion_image
* Type: String
* Desc: Image type you want to use for the bastion server. This can be either a custom image or IBM Cloud stock image. Image ID is 41 characters and region-specific.
**/
variable "bastion_image" {
  description = "Image type you want to use for the bastion server. This can be either a custom image or IBM Cloud stock image. Image ID is 41 characters and region-specific. [Learn more](https://cloud.ibm.com/docs/vpc?topic=vpc-about-images&interface=ui)"
  type        = string
  validation {
...
/**
* Name: bastion_ip_count
* Type: number
* Desc: Total host IPs for the bastion subnet. Valid values 8, 16, 32, 64.
*/
...
* Type: String
* Desc: IBM Cloud object name for bastion server SSH key.
**/
...
* Type: String
* Desc: VSI profile size which determines size of vCPU, RAM and network bandwidth for the bastion server. [Learn more](https://cloud.ibm.com/docs/vpc?topic=vpc-profiles&interface=ui)
**/
