 ...
 * Type: String
 * Desc: VSI profile size which determines size of vCPU, RAM and network bandwidth for the web servers. [Learn more](https://cloud.ibm.com/docs/vpc?topic=vpc-profiles&interface=ui)
 **/
...
* Name: web_image
* Type: String
* Desc: Image type you want to use for the web server. This can be either a custom image or IBM Cloud stock image. Image ID is 41 characters and region-specific.
**/
variable "web_image" {
  description = "Image type you want to use for the web server. This can be either a custom image or IBM Cloud stock image. Image ID is 41 characters and region-specific. [Learn more](https://cloud.ibm.com/docs/vpc?topic=vpc-about-images&interface=ui)"
  type        = string
  validation {
...
* Type: number
* Desc: Maximum web server count that the instance group can scale up to. Allowed value is between 1 and 1000. [Learn more](https://cloud.ibm.com/docs/vpc?topic=vpc-profiles&interface=ui)
**/
...
* Type: number
* Desc: Minimum web server count that the instance group cannot go below. Allowed value is between 1 and 1000. [Learn more](https://cloud.ibm.com/docs/vpc?topic=vpc-profiles&interface=ui)
**/
...
* Type: number
* Desc: The average utilization the web server instance group should achieve. This value defines when to add or remove web server instances to the group. Value should be between 10 and 90. [Learn more](https://cloud.ibm.com/docs/vpc?topic=vpc-creating-auto-scale-instance-group&interface=ui)
**/
...
* Type: number
* Desc: The aggregation window is the time period in seconds that the instance group manager monitors each instance and determines the average utilization for the web servers group. Value should be between 90 to 600. [Learn more](https://cloud.ibm.com/docs/vpc?topic=vpc-creating-auto-scale-instance-group&interface=ui)
**/
...
* Type: number
* Desc: The cooldown period is the time in seconds to pause further scaling actions after scaling takes place for the web servers. Value should be between 120 and 3600.  [Learn more](https://cloud.ibm.com/docs/vpc?topic=vpc-creating-auto-scale-instance-group&interface=ui)
**/
 ...
 * Type: String
 * Desc: VSI profile size which determines size of vCPU, RAM and network bandwidth for the app servers. [Learn more](https://cloud.ibm.com/docs/vpc?topic=vpc-profiles&interface=ui)
 **/
...
* Name: app_image
* Type: String
* Description: Image type you want to use for the app server. This can be either a custom image or IBM Cloud stock image. Image ID is 41 characters and region-specific.
**/
variable "app_image" {
  description = "Image type you want to use for the app server. This can be either a custom image or IBM Cloud stock image. Image ID is 41 characters and region-specific. [Learn more](https://cloud.ibm.com/docs/vpc?topic=vpc-about-images&interface=ui)"
  type        = string
  validation {
...
* Type: number
* Desc: The aggregation window is the time period in seconds that the instance group manager monitors each instance and determines the average utilization for the app servers group. Value should be between 90 to 600. [Learn more](https://cloud.ibm.com/docs/vpc?topic=vpc-creating-auto-scale-instance-group&interface=ui)
**/
...
* Type: number
* Desc: The cooldown period is the time in seconds to pause further scaling actions after scaling takes place for the app servers. Value should be between 120 and 3600.  [Learn more](https://cloud.ibm.com/docs/vpc?topic=vpc-creating-auto-scale-instance-group&interface=ui)
**/
