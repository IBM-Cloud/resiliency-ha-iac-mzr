...
| Name | Description |
|------|-------------|
| <a name="output_db_target"></a> [db\_target](#output\_db\_target) | Primary IP address for the DB VSI |
| <a name="output_db_vsi"></a> [db\_vsi](#output\_db\_vsi) | Refrence of DB VSI |
